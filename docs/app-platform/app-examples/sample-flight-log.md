...
{% file src="../../../.gitbook/assets/example_plan_2020-11-13-011622-444.log" %}
Example Flight Log
{% endfile %}
...
## \[iOS] Changes coming in November 2020
...
## \[Android] Changes coming in December 2021

### Main Body

The **Info** column has changed from a `-` separated list of strings to a JSON Array of values. This section now matches the iOS log format.\
\
Existing events will be JSON Objects of format:
